...
export const PrivacyPage: PageFactory<StudioService> = ({}: PageContext<StudioService>) => (
    <div className={className}>
        ...
        <p style={{color: Colors.blue.toString()}}>VRSA respects your privacy. This application does not collect
        ...
        <p>If you choose to connect a cloud service (e.g. Google Drive or Dropbox), VRSA uses the official OAuth
            process. The access tokens are stored only in your browser or desktop app and are never shared with us.</p>
        <h3>Data usage</h3>
        <p>VRSA does not process, analyze, or share any personal data. Files remain under your control in your chosen
            storage location.</p>
        <h3>Contact</h3>
        <p>For questions about this policy, contact: <a style={{color: Colors.blue}}
                                                        href="mailto:support@vrsa.app">support@vrsa.app</a>
        </p>
    </div>
)